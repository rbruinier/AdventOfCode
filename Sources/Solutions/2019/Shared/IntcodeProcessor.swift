...
final class IntcodeProcessor {
	private enum Value: CustomStringConvertible {
		...
		var description: String {
			...
			case .relative(let offset): "relative(\(offset))"
			}
		}
	}
