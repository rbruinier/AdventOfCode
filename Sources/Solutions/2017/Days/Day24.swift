...
final class Day24Solver: DaySolver {
    ...
    let expectedPart1Result = 1940
    let expectedPart2Result = 1928
    ...
    func solvePart1() -> Int {
        return bestStrength(withInput: 0, remainingPorts: Set(input.ports))
    }

    func solvePart2() -> Int {
        return bestLength(withInput: 0, remainingPorts: Set(input.ports)).strength
    }
