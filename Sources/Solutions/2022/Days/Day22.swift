...
final class Day22Solver: TestableDaySolver {
    ...
    func solvePart2() -> Int {
        ...
        let sideMappings: [Side: SideTranslation] = [
            .init(0, a): .init(5, b, .ninety, transform: { p, width in Point2D(x: 0, y: p.x) }),
            ...
            .init(2, b): .init(4, a, .twoSeventy, transform: { p, width in Point2D(x: p.y, y: 0) }),
            ...
            .init(4, a): .init(2, b, .ninety, transform: { p, width in Point2D(x: 0, y: p.x) }),
