...
public struct HexPoint: Hashable {
    ...
    public func moved(to direction: HexDirection, steps: Int = 1) -> HexPoint {
        switch direction {
        case .north: return self + .init(q: 0, r: -steps, s: steps)
        case .northEast: return self + .init(q: steps, r: -steps, s: 0)
        case .southEast: return self + .init(q: steps, r: 0, s: -steps)
        case .south: return self + .init(q: 0, r: steps, s: -steps)
        case .southWest: return self + .init(q: -steps, r: steps, s: 0)
        case .northWest: return self + .init(q: -steps, r: 0, s: steps)
        }
    }
}
