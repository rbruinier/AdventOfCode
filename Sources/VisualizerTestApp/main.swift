...
visualizer.fillRect(.init(origin: .init(x: 12, y: 42), size: .init(width: 96, height: 96)), color: .init(0xFFFF0000))
visualizer.fillRect(.init(origin: .init(x: 130, y: 70), size: .init(width: 80, height: 80)), color: .init(0xFF00FF00))
...
visualizer.drawRect(.init(origin: .init(x: 10, y: 40), size: .init(width: 100, height: 100)), width: 1, color: .init(0xFFFFFF00))
visualizer.drawRect(.init(origin: .init(x: 120, y: 60), size: .init(width: 100, height: 100)), width: 2, color: .init(0xFFFFFF00))
visualizer.drawRect(.init(origin: .init(x: 230, y: 80), size: .init(width: 100, height: 100)), width: 3, color: .init(0xFFFFFF00))
